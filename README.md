...
Projeto de automação desenvolvido em Python para organizar arquivos automaticamente em pastas com base em suas extensões.
...
* 📄 Identifica tipos de arquivos por extensão
...
- [ ] Trannsformar em app executavel (.exe)
